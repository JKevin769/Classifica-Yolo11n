...
# Configurações para a pasta ferrugem
pasta_dos_jsons = "yolo26segm/datasets/images/train/ferrugem" 
pasta_das_mascaras = "mascaras_geradas/train/ferrugem"

converter_json_para_mascara(
pasta_dos_jsons, 
pasta_das_mascaras
)
